...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SearchResultsViewController *dest = [[UIStoryboard storyboardWithName:@"MainStoryboard_iPhone" bundle:nil] instantiateViewControllerWithIdentifier:@"SearchResultsViewController"];
    
    dest.resultsList = [appDelegate.dbManager searchForWord:mutableEntries[indexPath.row]];
    
    [appDelegate.deckView.navigationController pushViewController:dest animated:YES];
    
    [searchDisplayController setActive:NO animated:YES];
    
    [_sidebarVC removeTap];
